...
const funexpression = function () { console.log("function expresion :when we pass annonymous fun into the variable , variable becomes like expression is called function expression")}
